...
/**
 * Represent tax filer which type is married, filling separately (inheriting GroupFiler)
 *
 * @author Xihao Liu
 */
public class MarriedSeparateFiler extends GroupFiler {

  /**
   * constructor of class MarriedSeparateFiler
   *
   ...
   */
  public MarriedSeparateFiler(String taxId, FilerType filerType, ContactInfo contactInfo,
    ...
    if (filerType != FilerType.MARRIED_FILLING_SEPARATELY) {
      throw new IllegalArgumentException(
          "Individual Filer Type Wrong! It should be MARRIED_FILLING_SEPARATELY.");
    }
  }

  /**
   * override equals method the same tax ID is treated as equal MarriedSeparateFiler objects
   *
  ...
  public String toString() {
    return "MarriedSeparateFiler{" + "incomeTaxPaid=" + incomeTaxPaid + ", lastYearEarnings="
        + lastYearEarnings + ", contactInfo=" + contactInfo + ", filerType=" + filerType
        + ", taxId='" + taxId + '\'' + ", specialExpense=" + specialExpense + '}';
  }
}
